      ...
      <section className="min-h-screen flex flex-col items-center justify-center bg-white px-4 pb-12 pt-28">
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-linear-to-r from-[#34ACE1] to-[#5BC7F7] px-6 py-2 text-base font-medium text-white hover:bg-sky-600 transition"
          >
            <span>
              <svg
                width="34"
          ...
          <Link
            href={
              "https://api.whatsapp.com/send/?phone=918698968698&text=Hi&type=phone_number&app_absent=0"
            }
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-green-500 px-6 py-2 text-base font-medium text-white hover:bg-green-600 transition min-w-[293px]"
          >
            <span>
              <Image
                src={"/whatsapp.svg"}
